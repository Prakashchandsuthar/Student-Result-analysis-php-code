...
<form id="form" name="form" method="post" action= "ssubreport.php" >
...
<form id="form" name="form" method="post" action= "sstudentreport.php" >
  <tr class="white">
    <td align="left" valign="top" class="white"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td width="4%" valign="top">&nbsp;</td>
...
<form id="form" name="form" method="post" action= "soverallreport.php" >
...
<form id="form" name="form" method="post" action= "subreport.php" >
  ...
  <tr class="white">
	...
	<p>
                              <label><br>
                               <a href="index.php"><input name="finish" type="button" class="menu" value="FINISH" /></a>
                              </label>
</p>	               
