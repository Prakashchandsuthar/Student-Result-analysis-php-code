...
<form id="form" name="form" method="post" action= "del2.php" >
  <tr class="white">
 ...
 <tr>
	 ...
	 <tr>
		...
		<?php } ?>
                                                   ...
                                                   <tr>
 <td>Enter Id To Delete:  <input name="delid" type="text" class="menu" id="name" maxlength="25" /><br><br>
 ...
 <label><br>
                            ...
                            <a href="logon.php"><input type="button" value="FINISH"></a>
                              </label>
</body>
